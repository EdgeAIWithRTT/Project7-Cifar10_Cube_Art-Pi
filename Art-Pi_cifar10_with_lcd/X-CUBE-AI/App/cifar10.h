...
#ifndef __AI_CIFAR10_H__
#define __AI_CIFAR10_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_CIFAR10_MODEL_NAME          "cifar10"

#define AI_CIFAR10_ACTIVATIONS_ALIGNMENT   (4)

#define AI_CIFAR10_IN_NUM       (1)
#define AI_CIFAR10_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 32, 32, 3, 1, NULL), \
}
#define AI_CIFAR10_IN_SIZE { \
  (32 * 32 * 3), \
}
#define AI_CIFAR10_IN_1_SIZE  (32 * 32 * 3)
#define AI_CIFAR10_IN_1_SIZE_BYTES  ((32 * 32 * 3) * 1)





#define AI_CIFAR10_OUT_NUM      (1)
#define AI_CIFAR10_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 10, 1, NULL), \
}
#define AI_CIFAR10_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_CIFAR10_OUT_1_SIZE  (1 * 1 * 10)
#define AI_CIFAR10_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 1)

#define AI_CIFAR10_N_NODES (23)
 ...
 * @ref ai_cifar10_create. Both the activations memory buffer 
 ...
 * using @ref ai_cifar10_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_CIFAR10_*
 * defines into file @ref cifar10.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_cifar10_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_CIFAR10_H__*/
